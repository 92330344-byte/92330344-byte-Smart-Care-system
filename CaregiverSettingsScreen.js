...
export default function CaregiverSettingsScreen({ navigation }) {
  const switchUser = () => {
  ...
  return (
    <ScrollView style={styles.container} showsVerticalScrollIndicator={false}>
      ...
      <View style={styles.header}>
        ...
        <Text style={styles.headerText}>Caregiver Settings</Text>
      ...
      <View style={styles.card}>
        ...
        >
          ...
          <View style={styles.optionInfo}>
            ...
            <Text style={styles.optionSub}>Edit caregiver information</Text>
          </View>
        ...
        >
          ...
          <View style={styles.optionInfo}>
            ...
            <Text style={styles.optionSub}>Manage patient medication reminders</Text>
          </View>
